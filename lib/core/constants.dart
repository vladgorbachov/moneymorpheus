...
const Color darkSphereColor2 = Color(0xFF242424);
const Color accentColor = Color(0xFF658FA4);

// Light mode (ref image_1.png palette)
const Color lightBackgroundColor = Color(0xFFE7E7E7);
